...
public class ClientProjectComponent extends AbstractTimeregistrationComponent implements TimeregistrationEventListener {

	private static final long serialVersionUID = 1L;
	protected Logger logger = LoggerFactory.getLogger(getClass());

	GridLayout layout = new GridLayout(3, 1);
	Label clientProjectLabel = new Label("ClientProjects");
	ComboBox clientProjects = new ComboBox();

	public ClientProjectComponent(String style) {
		super(style);

		layout.addComponent(clientProjectLabel);
		layout.addComponent(clientProjects);
