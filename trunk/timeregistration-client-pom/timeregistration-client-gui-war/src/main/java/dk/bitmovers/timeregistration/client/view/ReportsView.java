...
public class ReportsView extends AbstractView<ReportsView> {
	...
	// public ReportsView(TimeregistrationNavigatorUI trNavigator, final ViewInfo
	// viewInfo, final List<ViewInfo> items) {
	...
	public ReportsView(TimeregistrationNavigatorUI timeregistrationNavigatorUI, ViewInfo viewInfo, DataProvider dataProvider) {
