...
public class SingleDayPeriodOnAcnCode extends PeriodWithOneTimeslotOnAcnCode {

	public SingleDayPeriodOnAcnCode(DateTime theDate) {
	...
	public String getName() {
		return "SingleDayPeriodOnAcnCode";
	}
