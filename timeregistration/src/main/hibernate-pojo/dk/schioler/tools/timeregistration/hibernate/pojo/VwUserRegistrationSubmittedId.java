...
/**
 * VwUserRegistrationSubmittedId generated by hbm2java
 */
public class VwUserRegistrationSubmittedId implements java.io.Serializable {
	...
	public VwUserRegistrationSubmittedId() {
	}

	public VwUserRegistrationSubmittedId(int userId, String userLogin,
			int itemId, String itemProjectName, String itemItemName,
			String clientName, String clientCode, String clientCodeName,
			String providerName, String providerCode, String providerCodeName,
			int eventId, BigDecimal amount) {
		this.userId = userId;
	...
	public VwUserRegistrationSubmittedId(int userId, String userLogin,
			...
			String clientName, String clientCode, String clientCodeName,
			String providerName, String providerCode, String providerCodeName,
			int eventId, BigDecimal amount, String comments) {
		this.userId = userId;
		this.userLogin = userLogin;
		this.itemId = itemId;
		this.itemProjectName = itemProjectName;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VwUserRegistrationSubmittedId))
			return false;
		VwUserRegistrationSubmittedId castOther = (VwUserRegistrationSubmittedId) other;
