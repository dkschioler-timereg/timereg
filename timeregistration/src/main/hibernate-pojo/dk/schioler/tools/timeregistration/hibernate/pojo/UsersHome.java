 ...
 * @see dk.schioler.tools.timeregistration.hibernate.pojo.Users
...
public class UsersHome {
	...
	public Users findById(
			dk.schioler.tools.timeregistration.hibernate.pojo.UsersId id) {
		log.debug("getting Users instance with id: " + id);
		try {
			Users instance = (Users) sessionFactory.getCurrentSession().get(
					"dk.schioler.tools.timeregistration.hibernate.pojo.Users",
					id);
			if (instance == null) {
